...
base_path = '/data/wiay/postgrads/shashwat/EMRI_data/INFERENCE_DATA/_pop_B_NO_SF'
...
plt.tight_layout()
plt.savefig('/data/wiay/postgrads/shashwat/EMRI_data/INFERENCE_DATA/PLOTS/PPD_B_hist.png', dpi=300)
plt.savefig('/data/wiay/postgrads/shashwat/EMRI_data/INFERENCE_DATA/PLOTS/PPD_B_hist.pdf', dpi=300)