...
truths = [
    ...
    true_x_MIX['log10_M']['xc_B'],
    true_x_MIX['log10_mu']['alpha_B'],
    true_x_MIX['a']['alpha_B'],
    true_x_MIX['a']['beta_B'],
    true_x_MIX['e0']['alpha_B'],
    true_x_MIX['e0']['beta_B'],
    0.7
]
...
base_path = '/data/wiay/postgrads/shashwat/EMRI_data/INFERENCE_DATA/_pop_MIX_A_A'
...
post_top_axes = [fig.add_subplot(gs_post_top[i, j]) for i in range(4) for j in range(2)]
...
labels_post = ["$x_c^{\\mathrm{A}}$", "$\\gamma^{\\mathrm{A}}_{\\mu}$", "$\\alpha^{\\mathrm{A}}_a$", "$\\beta^{\\mathrm{A}}_a$", "$\\alpha^{\\mathrm{A}}_{e0}$", "$\\beta^{\\mathrm{A}}_{e0}$","$x_c^{\\mathrm{B}}$", "$\\gamma^{\\mathrm{B}}_{\\mu}$", "$\\alpha^{\\mathrm{B}}_a$", "$\\beta^{\\mathrm{B}}_a$", "$\\alpha^{\\mathrm{B}}_{e0}$", "$\\beta^{\\mathrm{B}}_{e0}$", "$w$"]

y_positions = [0.95, 0.75, 0.55]
x_positions = [0.90, 0.90, 0.05, 0.05, 0.05, 0.90, 0.90, 0.90, 0.05, 0.90, 0.05, 0.05, 0.05]
ha_positions = ['right','right','left','left','left','right', 'right','right', 'left', 'right', 'left', 'left', 'left']
...
plt.savefig("/data/wiay/postgrads/shashwat/EMRI_data/INFERENCE_DATA/PLOTS/combine_plot_MIX_A_A_posterior1D_PPD.png", dpi=300, bbox_inches="tight")
plt.savefig("/data/wiay/postgrads/shashwat/EMRI_data/INFERENCE_DATA/PLOTS/combine_plot_MIX_A_A_posterior1D_PPD.pdf", dpi=300, bbox_inches="tight")